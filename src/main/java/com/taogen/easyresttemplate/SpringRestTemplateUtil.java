package com.taogen.easyresttemplate;
...
public class SpringRestTemplateUtil {
    ...
    public HttpResponse requestWithJson(HttpRequestWithJson request) throws IOException {
        if (request.getMethod() == com.taogen.easyhttpclient.enums.HttpMethod.GET) {
...
//        headers.add("Content-Type", MediaType.APPLICATION_FORM_URLENCODED.toString());
    ...
    private static HttpMethod convertToSpringHttpMethod(com.taogen.easyhttpclient.enums.HttpMethod method) {
        if (com.taogen.easyhttpclient.enums.HttpMethod.GET.equals(method)) {
            return HttpMethod.GET;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.POST.equals(method)) {
            return HttpMethod.POST;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.PUT.equals(method)) {
            return HttpMethod.PUT;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.DELETE.equals(method)) {
            return HttpMethod.DELETE;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.HEAD.equals(method)) {
            return HttpMethod.HEAD;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.OPTIONS.equals(method)) {
            return HttpMethod.OPTIONS;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.PATCH.equals(method)) {
            return HttpMethod.PATCH;
        } else if (com.taogen.easyhttpclient.enums.HttpMethod.TRACE.equals(method)) {
